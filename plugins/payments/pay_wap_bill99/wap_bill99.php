 ...
 * @brief 快钱在线(内卡)支付接口
 */
class wap_bill99 extends paymentPlugin
{
	//插件名称
    public $name = '快钱手机支付';
	...
	{
		//return 'https://sandbox.99bill.com/mobilegateway/recvMerchantInfoAction.htm';//测试地址
		return 'https://www.99bill.com/mobilegateway/recvMerchantInfoAction.htm';//生产地址
	}
